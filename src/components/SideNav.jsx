...
const SideNav = () => {
  ...
  return (
    <nav className="hidden md:flex flex-col h-full p-4 gap-4 bg-mw-sidebar font-nunito font-bold text-sm w-64 rounded-r-3xl border-r-8 border-[#3d1f08] border-r-4 shadow-[10px_0_15px_-3px_rgba(0,0,0,0.4)] z-40 sticky top-[72px]">
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-[#f0c87a]/70 font-caption normal-case">Your task board</p>
      </div>
